<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="JadeWeb.admin.Index" %>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
                    ...
                    <li class="active"><a href="javascript:;" data-toggle="slidebar"><i class="fa fa-check-square-o"></i> 功能管理 </a>
                        <div class="items hide" data-noinit="true">
                            <ul id="bjui-hnav-tree1" class="ztree ztree_main" data-toggle="ztree" data-on-click="MainMenuClick" data-expand-all="true" data-faicon="check-square-o">
                                ...
                                <li data-id="55" data-pid="5" data-url="settings/setCustomerService.html" data-tabid="setCustomerService">客服设置</li>
                                <li data-id="56" data-pid="5" data-url="settings/seo.html" data-tabid="seo" >SEO设置</li> 
                                <li data-id="57" data-pid="5" data-url="http://tongji.baidu.com/web/welcome/login" data-tabid="tongji" >访问统计</li> 
                            </ul>  
                        </div>    
                    </li>
